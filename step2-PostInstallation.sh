...
echo -e "$BOLD_GREEN \t instead of qemu window. Default password is 1234 (user: ali) $TEXT_RST"
echo -e "$BOLD_GREEN \t NumPad does not work with QEMU window! $TEXT_RST"
...
echo -e "$BOLD_GREEN step2 finished! $TEXT_RST"
